                ...
                <Nav>
                    {
                        ...
                        <>
                            ...
                            <NavLink  eventKey='2' as={Link} to='/profile' className='mx-1'>
                                <FontAwesomeIcon icon={faUser} fixedWidth/>
                                <span>&nbsp;&nbsp;Profil</span>
                            </NavLink>
                            <NavLink  eventKey='3' onClick={logOut} className='mx-1'>
                                <FontAwesomeIcon icon={faArrowRightToBracket} flip='horizontal' fixedWidth/>
                                <span>&nbsp;&nbsp;Wyloguj się</span>
                            </NavLink>
                        </> :
                        <>
                            <NavLink  eventKey='4' as={Link} to='/login' className='mx-1'>
                                <FontAwesomeIcon icon={faArrowRightToBracket} fixedWidth/>
                                <span>&nbsp;&nbsp;Zaloguj się</span>
                            </NavLink>
                            <NavLink  eventKey='5' as={Link} to='/register' className='mx-1'>
